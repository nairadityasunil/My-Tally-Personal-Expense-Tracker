                                ...
                                <div class="card-body overflow-auto">
                                    ...
                                    <form action="{{ route('save_payable') }}" method="POST">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="payable_id" class="form-control"
                                                    id="payable_id" placeholder="" value="{{ $entry_id->id }}"
                                                    readonly="readonly">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="name" class="form-control" id="name"
                                                    placeholder="" value="{{ $entry_id->name }}" readonly="readonly">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="purpose" class="form-control" id="purpose"
                                                    placeholder="" value="{{ $entry_id->purpose }}" readonly="readonly">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="row ">
                                                    <div class="col-sm-4">
                                                        <input type="text" name="action" class="form-control"
                                                            id="purpose" placeholder="" value="paid"
                                                            readonly="readonly">
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="total_amount" class="form-control"
                                                    id="name" placeholder="" value="{{ $entry_id->amount }}"
                                                    readonly="readonly">
                                            </div>
                                        </div>
                                                    ...
                                                    @foreach ($all_payables as $payables)
                                                        @if ($payables->id != $entry_id->id)
                                                            <tr>
                                                                <td>{{ $payables->id }}</td>
                                                                <td>{{ $payables->name }}</td>
                                                                <td style="color:red;"><b>{{ $payables->amount }}</b>
                                                                </td>
                                                                <td>
                                                                    <a href="{{ url('confirm_payable') }}/{{ $payables->id }}"
