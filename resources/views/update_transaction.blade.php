                                ...
                                <div class="card-body overflow-auto">
                                    ...
                                    <form action="{{route('save_update_transaction')}}" method="POST">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-4">
                                                <center>
                                                    <label for="name" class="col-form-label">Transaction Id :</label>
                                                </center>
                                            </div>
                                            <div class="col-sm-6">
                                                <input type="text" name="id" class="form-control" id="id" placeholder="" value="{{$update_transaction->id}}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="name" class="form-control" id="name" placeholder="" value="{{$update_transaction->name}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="purpose" class="form-control" id="purpose" placeholder="" value="{{$update_transaction->purpose}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="row ">
                                                    <div class="col-sm-4">
                                                        <input type="text" name="action" class="form-control" id="action" placeholder="" value="{{$update_transaction->action}}" readonly>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="row">   
                                                            <div class="col-sm-5">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <select class="form-select" aria-label="Default select example" name="mode">
                                                                    <option value="{{$update_transaction->mode}}" selected>{{$update_transaction->mode}}</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="total_amount" class="form-control" id="name" placeholder="" value="{{$update_transaction->amount}}" readonly>
                                            </div>
                                        </div>
