                                    ...
                                    <form action="{{ route('save_transaction') }}" method="POST">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="container">
                                                <center>
                                                    <table
                                                        class="table table-striped  border-dark text-center w-75 px-2"
                                                        id="table">
                                                        <thead>
                                                            <tr>
                                                                <th>Name</th>
                                                        ...
                                                        <tbody>
                                                            <td>
                                                                <input type="text" name="inputs[0][entity_name]"
                                                                    readonly class="form-control table_input"
                                                                    id="name" placeholder="" value="Self">
                                                            </td>
                                                            <td>
                                                                <input type="text" name="inputs[0][amount]"
                                                                    class="form-control table_input" id="amount"
                                                                    placeholder="-" value="">
                                                            </td>
                                                            <td>
                                                                <button type="button" name="split_btn"
                                                                    class="btn btn-success"
                                                                    id="split_btn">Split</button>
                                                            </td>
                                                        </tbody>
                                                    </table>
                                                </center>
